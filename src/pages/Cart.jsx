...
//         will add logic when building backend
//     }
// useEffect(()=>{
...
//                             <img src={assets.refresh_icon} alt='remove' className='inline-block w-6 h-6'></img>
//                         </button>
//                     </div>)
//                 )}
...
//                    <img className='gropu-hover:-translate-x-1 transition' src={assets.arrow_right_icon_colored} alt='arrow'>
//                    </img>
//                     Continue Shopping
//                 </button>
