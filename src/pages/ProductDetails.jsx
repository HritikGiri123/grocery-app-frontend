...
// const[relatedProducts,satRelatedProducts]=useState([]);
...
//   satRelatedProducts(productsCopy.slice(0,5))
// }
//     },[products])
...
//                                 <img src={i<4?assets.star_icon:assets.star_dull_icon} alt='' className='md:w-4 w-3'></img>
  ...
  return (
    <div className="mt-12">
      ...
      <div className='flex flex-col items-center mt-20'>
        ...
        <div className='grid grid-col-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6 lg:grid-cols-5 mt-6 w-full'>
          {relatedProducts.filter((product)=>product.inStock).map((product,index)=>(
            <ProductCard key={index} product={product}/>
          ))}
        </div>
        <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary-dull/10 transition'>
          See more
        </button>
